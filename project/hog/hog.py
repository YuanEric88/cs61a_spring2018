    ...
    while True:
        if player == 0:
            ...
            if is_swap(score0, score1):
                score_middle = score0
                score0, score1 = score1, score_middle
        else:
            num_rolls = strategy1(score1, score0)
            score1 += take_turn(num_rolls, score0, dice)
            if is_swap(score1, score0):
                score_middle = score1
                score1, score0 = score0, score_middle
...
def announce_highest(who, previous_high = 0, previous_score = 0):
    ...
    # BEGIN PROBLEM 7
    def announce(score0, score1, previous_score, previous_high):
        if who == 0:
            if score0 == 1 and previous_score == 0:
                ...
                previous_high, previous_score = score0 - previous_score, score0
            else:
                previous_score = score0
        else:
            if score1 == 1 and previous_score == 0:
                ...
                previous_high, previous_score = score1 - previous_score, score1
            else:
                previous_score = score1
        return announce_highest(who, previous_high=previous_high, previous_score=previous_score)
    return announce
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for i in range(1,11):
        ...
        avg_value = averaged(i, dice)
        if avg_value > avg_highest:
            num_roll_highest, avg_highest = i, avg_value
    return num_roll_highest
    # END PROBLEM 9
