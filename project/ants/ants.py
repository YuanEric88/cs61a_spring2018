	...
	def add_insect(self, insect):
		...
		if insect.is_ant:
			if self.ant is None:
				...
				# BEGIN Problem 9
				if self.ant.container and self.ant.ant == None and (not insect.container):
...
class ThrowerAnt(Ant):
	...
	def nearest_bee(self, hive):
		...
		n_place = 0
		while True:
			if n_place >= self.min_range and n_place <= self.max_range:
				if current_place is hive:
					return None
			...
			while True:
				if current_place.exit != None:
					...
					if next_place.ant != None:
						if next_place.ant.container == True:
							if next_place.ant.can_double_damage == True:
								next_place.ant.damage *= 2
								next_place.ant.can_double_damage = False
							if next_place.ant.ant != None and next_place.ant.ant.can_double_damage == True:
								next_place.ant.ant.damage *= 2
								next_place.ant.ant.can_double_damage = False
						elif next_place.ant.can_double_damage == True:
							next_place.ant.damage *= 2
							next_place.ant.can_double_damage = False
