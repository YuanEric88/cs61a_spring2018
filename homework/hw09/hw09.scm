...
(define (derive-product expr var)
  (define first_part (make-product (derive (multiplier expr) var) (multiplicand expr)))
  (define next_part (make-product (derive (multiplicand expr) var) (multiplier expr)))
  (make-sum first_part next_part)
)
